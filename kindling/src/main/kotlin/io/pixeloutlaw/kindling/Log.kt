...
public object Log {
    ...
    public fun verbose(
        ...
        tag: String = "",
    ): Unit = logAtLevel(Level.VERBOSE, tag, throwable, message)
    ...
    public fun debug(
        ...
        throwable: Throwable? = null,
        tag: String = "",
    ): Unit = logAtLevel(Level.DEBUG, tag, throwable, message)
    ...
    public fun info(
        ...
        throwable: Throwable? = null,
        tag: String = "",
    ): Unit = logAtLevel(Level.INFO, tag, throwable, message)
    ...
    public fun warn(
        ...
        throwable: Throwable? = null,
        tag: String = "",
    ): Unit = logAtLevel(Level.WARNING, tag, throwable, message)
    ...
    public fun error(
        ...
        throwable: Throwable? = null,
        tag: String = "",
    ): Unit = logAtLevel(Level.ERROR, tag, throwable, message)
    ...
    public fun assert(
        ...
        throwable: Throwable? = null,
        tag: String = "",
    ): Unit = logAtLevel(Level.ASSERT, tag, throwable, message)
